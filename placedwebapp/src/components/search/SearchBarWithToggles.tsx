...
// interface SearchBarWithTogglesProps {
//   // Search values
//   searchQuery: string;
//   location: string;
...
// export function SearchBarWithToggles({
//   searchQuery,
//   location,
//   onSearchQueryChange,
//   onLocationChange,
...
//   return (
//     <div className="w-full bg-background-primary pt-6">
//       <Container size="xl">
//         {/* Desktop Layout - Clean Flex Container */}
//         <div className="hidden lg:flex gap-8">
//           {/* Left Container - Filters (300px) */}
//           <div className="w-[300px] flex-shrink-0">
//             {/* Empty spacer for filter alignment */}
//           </div>
          
//           {/* Right Container - Search Content */}
//           <div className="flex-1 min-w-0">
//             {/* Search Bar Container - 695px width, 24px from top */}
//             <div className="w-[695px] flex flex-col gap-6">
//               {/* Search Bar - 695×48px */}
//               <div
//                 className={`w-[695px] h-12 bg-surface rounded-lg shadow-lg border flex items-center relative transition-normal
...
//               {/* Toggle Switches Container - 559px */}
//               <div className="w-full h-6 flex justify-between gap-2 p-2">
...
//                 {/* Exclude My Clients Switch */}
//                 <div className="flex items-center gap-2">
//                   <Switch
//                     id="excludeMyClients"
//                     checked={toggles.excludeMyClients}
//                     onCheckedChange={(checked) => onToggleChange('excludeMyClients', checked)}
//                     className="w-[40px] h-6 data-[state=checked]:bg-primary data-[state=unchecked]:bg-[#E4E8EE]"
//                   />
//                   <Label
//                     htmlFor="excludeMyClients"
//                     className="text-sm font-medium text-text-primary cursor-pointer leading-none min-w-[124px] whitespace-nowrap"
//                   >
//                     {dict.toggles.excludeMyClients}
//                   </Label>
//                 </div>
//               </div>
//             </div>
...
//                 value={location}
//                 onChange={(e) => onLocationChange(e.target.value)}
//                 className="pl-10 pr-20 h-12 border-0 focus:ring-0 bg-transparent"
//               />
...
//                 checked={toggles.onlyPaidAds}
//                 onCheckedChange={(checked) => onToggleChange('onlyPaidAds', checked)}
//                 className="data-[state=checked]:bg-primary data-[state=unchecked]:bg-[#E4E8EE]"
//               />
//               <Label 
//                 htmlFor="onlyPaidAds-mobile" 
...
//               />
//               <Label 
//                 htmlFor="excludeHeadhunters-mobile" 
//                 className="text-sm font-medium text-text-primary cursor-pointer"
//               >
//                 {dict.toggles.excludeHeadhunters}
//               </Label>
...
//               />
//               <Label 
//                 htmlFor="excludeMyClients-mobile" 
//                 className="text-sm font-medium text-text-primary cursor-pointer"
//               >
//                 {dict.toggles.excludeMyClients}
//               </Label>
