...
export function JobCard({ 
  ...
  if (!job) {
    return (
      <div className="w-full max-w-[952px] h-[192px] bg-white border border-border rounded-[4px] pt-6 pb-4 transition-shadow">
  ...
  return (
    <div className="w-full max-w-[952px] h-[192px] space-y-4"> 
      <div className="flex flex-start">
      <button onClick={handleCardClick} 
      className="flex items-center w-30 gap-4 text-text-primary text-lg font-medium rounded-full hover:shadow-lg scale-105 transition-all duration-300">
      ...
      Zurück
        ...
        <div className="h-full px-6 bg-white border border-border rounded-[6px] pt-6 pb-4 transition-shadow">
          ...
          <div className="w-full h-8 flex items-center gap-6 pt-2">         
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-sm text-text-secondary">{formatDate(job.postedDate)}</span>
            </div>
            <div className="flex items-center gap-1">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="bg-navy" className="size-4">
          ...
          <div className="w-full h-8 flex items-center gap-6 pt-2">
            ...
            {job.listedOn && job.listedOn.length > 0 && (
              <div className="flex items-center gap-2">
                <span className="text-sm text-text-secondary">{dict.listedOn}</span>
                <div className="flex items-center gap-2">
