    ...
    <div className="relative w-full max-w-[952px] h-[498px]">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center space-y-8">
        ...
        <div className="text-center space-y-4">
            <h3 className="text-xl font-semibold text-primary">Generiere AI Profiloptimierer</h3>
...
interface SalesPitchLoadingCardProps {
  isGenerating: boolean;
}

  export function SalesPitchLoadingCard({ isGenerating }: SalesPitchLoadingCardProps) {
  if (!isGenerating) return null;

  const loadingMessages = [
    "Analysiere Anforderungen...",
    "Verarbeite Kandidatenprofil...",
    "Generiere AI Gesprächsleitfaden...",
    "Finalisiere Ergebnisse..."
  ];
  ...
  return (
    <div className="relative w-full max-w-[952px] h-[498px]">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center space-y-8">
        ...
        {/* Animated Loading Text */}
        <div className="text-center space-y-4">
            <h3 className="text-xl font-semibold text-primary">Generiere AI Gesprächsleitfaden</h3>
